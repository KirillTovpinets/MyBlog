  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'parent' => 'components',
        'action' => '3',
        'description' => 'Управления и подтверждение комментариев modxTalks.',
        ...
        array (
          ...
          array (
            ...
            'parent' => 'modxtalks',
            'action' => '3',
            'description' => '<div id="comments_unconfirmed"><span></span></div>Неподтвержденные комментарии',
            'icon' => 'images/icons/plugin.gif',
            'menuindex' => 0,
            ...
            'action_controller' => 'index',
            'action_namespace' => 'modxtalks',
            'id' => 'modxtalks.comments_unconfirmed',
            'children' => 
            array (
            ),
            'controller' => '',
          ...
          3 => 
          array (
            'text' => 'Блокирование Email адреса',
            'parent' => 'modxtalks',
            'action' => '3',
            'description' => '',
            'icon' => 'images/icons/plugin.gif',
          ...
          array (
            ...
            'parent' => 'modxtalks',
            'action' => '3',
            'description' => 'Документация по modxTalks комментариям.',
            'icon' => 'images/icons/plugin.gif',
            'menuindex' => 1,
            'params' => '',
          ...
          array (
            ...
            'parent' => 'modxtalks',
            'action' => '3',
            'description' => 'Демо сайт комментариев modxTalks.',
            'icon' => 'images/icons/plugin.gif',
            'menuindex' => 2,
            'params' => '',
