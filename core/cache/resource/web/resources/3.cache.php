<?php  return array (
  ...
  array (
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '<div id="pdopage" class="blog-wrapper">
    <div class="rows blog-list blogfitrows blogbox">
        [[!pdoPage?
            &tpl=`post-default`
            ...
            &ajaxMode=`button`
            &limit=`4`
            &ajaxTplMore=`@INLINE <div class="load-more-wrapper">
                        <button class="btn btn-info btn-more">Загрузить ещё</button>
                        </div>`
        ]]
    </div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1484575262,
    'editedby' => 1,
    'editedon' => 1484898700,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1484575260,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html>
  ...
  <head>
    ...
    <!-- Full Page -->
    <link href="assets/templates/plugins/fullpage/jquery.fullPage.css" rel="stylesheet" media="screen">
    <!-- Audio Player -->
    <link rel="stylesheet" href="assets/templates/plugins/audioPlayer/css/audioplayer.css" />
    <!-- Mouse Move Plugin -->
    ...
    <!-- FlexSlider -->
    <link href="assets/templates/plugins/flexslider/flexslider.css" rel="stylesheet">
    <!-- Audio Player -->
    <link rel="stylesheet" href="assets/templates/plugins/audioPlayer/css/audioplayer.css" />
    <!-- Style Sheets -->
  ...
  <ul class="mobile-sub wsmenu-list">
    <li><li class="first"><a href="index.php?id=1" >Главная</a></li><li><a href="index.php?id=2" >Закаливание</a></li><li class="active"><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></li>
      ...
      <!-- HEADER ENDS  -->
      <!-- INTRO PAGE START -->
      <section id="page-title" class="default-page-title white-background">
      ...
      <section class="section gray-background clearfix">
        <div class="container-fluid">
          <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
            <div class="row">
              <div id="pdopage" class="blog-wrapper">
    <div class="rows blog-list blogfitrows blogbox">
        [[!pdoPage?
            &tpl=`post-default`
            &includeTVs=`image, HitsPage`
    ...
    <div class="load-more-wrapper">
        [[!+page.nav]]
          ...
          <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                [[!SimpleSearchForm? &landing=`37` &tpl=`search-popup`]]  
            <div class="widget">
              <h4>Категории</h4>
...
<li>
    <a href="index.php?id=61" class="image-thumb">
        <img src="assets/templates/images/running/x5cmpfPJ_Jk.jpg" alt="">
    </a>
    <a class="ssp-title" href="index.php?id=61">Помни, что ты уникальный!</a>
    <span class="ssp-price">29 января 2017</span>
</li>
<li>
...
background-image: -ms-linear-gradient(left, rgb(77,92,178) 24%, rgb(68,81,167,1) 100%);">
  ...
  <!-- FlexSlider -->
  <script type="text/javascript" src="assets/templates/plugins/flexslider/jquery.flexslider-min.js"></script>
  <!-- Google Map -->
  <script type="text/javascript" src="assets/templates/plugins/slick/slick.min.js"></script>
  <!-- Audio Player -->
  <script type="text/javascript" src="assets/templates/plugins/audioPlayer/js/audioplayer.js"></script>
  <!-- Google Map -->
  <script type="text/javascript" src="assets/templates/plugins/slick/slick.min.js"></script>
  ...
  'elementCache' => 
  array (
    '[[$includes-list]]' => '<title>Программирование</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="initial-scale=1.0,user-scalable=no,maximum-scale=1">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="HandheldFriendly" content="True">
...
<li>
    ...
    '[[dateRU? &MyDate=`29 January 2017`]]' => '29 января 2017',
...
<li><a target="_blank" class="popup-share" href="http://www.twitter.com/share?url=http://buildyourself.by/index.php?id=66&text=Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги."><span class="icon-twitter"></span></a></li>',
    '[[dateRU? &MyDate=`22 December 2016`]]' => '22 декабря 2016',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
