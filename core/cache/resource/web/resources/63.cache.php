<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Закаливание вредит вашему здоровью!',
    'longtitle' => '',
    'description' => '',
    'alias' => 'zhes-podskazhet,-kogda-idti-dalshe!',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    'parent' => 2,
    'isfolder' => 0,
    'introtext' => 'Как часто я слышу в последнее время мнения о том, что закаливание вредит моему здоровью, и люди иногда приводят достаточно сильные аргументы по этому поводу. Однако эти аргументы зачастую поверхностные.',
    'content' => '<div class="blog-post-fullwidth-featured js-parallax" data-parallax="scroll" data-image-src="assets/templates/images/hardening/Me.jpg">
        <div class="container-fluid">
          <div class="post-single-title"> 
          [[!tagLister? &parents=`[[*id]]` &tv=`tags` &tpl=`single-tag` &target=`38`]]
            <h1>[[*pagetitle]]</h1>
            <div class="blog-single-meta" style="color: #333;">
              <p><a href="#" class="single-comments" id="comments"><span class="icon-comments-2"></span></a><a href="#" class="single-shares"><span class="icon-eye"></span>[[!HitsPage? &saveTv=`true`]]</a> </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="section clearfix">
        <div class="container-fluid">
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            ...
            <p>
                Как я уже писал в <a href="[[~61]]">одной из статей</a>, многие люди, зачастую пользуются стереотипами в тех ситуациях, когда
                не могут объяснить то, что видят. В случае с закаливанием, многие не понимают, как можно ходить в -10 в одной майке, именно поэтому
                мне не раз говорили: "Вот увидишь, попадёшь в больницу, носи тебе потом фрукты да овощи!" Однако, увидев меня в майке первый, второй, 
                третий раз, люди начинают недоумевать, как такое возможно и, понятное дело, их стереотип не может объяснить этого. И люди начинают тогда
                гуглить, читают разные статьи, однако, как я понял, читают их выборочно, или просто пропускают то, что написано (в скобках).
            </p>
            <p>    
                В последнее время я слышу очень много мнений о том, что закаливание вредно для здоровья. Люди то и дело начинают убеждать меня
                в том, что закаляя свой организм до такой степени, чтобы ходить в -10 в одной майке, я могу угробить своё здоровье и оказаться на 
                больничной койке. В этой серии статей я постараюсь разъяснить вам всю специфику закаливания, её особенности, как ведёт себя организм в
                низких температурах, какие процессы при этом возникают и немного разрушу пару стереотипчиков. Итак, поехали.
            </p>
            <p>
                Первый вопрос, который мне задают те, кто впервые увидел меня в майке в мороз: "Тебе не холодно?". <br>
                Многие считают, что если человек ходит в майке в холодную погоду, то его тело выделяет достаточно тепла, чтобы согреть организм. То есть
                человеку тепло даже в такую погоду. Скажу вам, именно этот стереотип настораживал меня первое время, когда я только начинал закаляться. Меня пугало
                то, что если при низких температурах мне будет тепло, то как я тогда буду себя чувствовать летом, когда будет жарко. И я считал, что закаливание
                может сбить всю мою терморегуляцию. Однако, я всё же рискнул этим заняться. И теперь я вижу, что не зря. <br>
                Всё дело в том, что закаливание - это не поддержание нормальной температуры тела при низких температурах. Это скорее процесс, когда ты обучаешь 
                свой организм получать удовольствие от холода. Неподготовленный человек не может пробыть на холоде долгое время. Его организм сразу начинает трястись, 
                так как ему не приятен холод, ему некомфортно в этой среде. Закаливание же помогает организму привыкнуть к холодной среде и получать от неё удовольствие.
                Да, звучит немного по-мазохистски, но зато возможности твоего организма увеличиваются в разы. И температура тела не повышается ни в коем случае при этом :).
                Так что на вопрос: "Холодно ли тебе?" правильный ответ: "Да,  холодно!" Но меня не трясёт от холода, я могу стоять на морозе достаточно долго.
                Да, бывают моменты, когда меня начинает потрясывать, но, как правило это ни к чему не приводит. Я спокойно могу просто перетерпеть это. Единственное, что в
                городском темпе жизни особо нет причин просто стоять. Да, бывают ситуации, когда стоишь на остановке, ждёшь автобус, но этого времени мне вполне хватает, чтобы
                мышцы не затряслись. Я думаю, тут всё зависит от степени закалённости. В движении (ходьба или бег) я могу пробыть на морозе на порядок дольше, так как при движении
                кровь разгоняется по мышцам и теплообмен увеличивается. По этой же причине после тренировок, когда я разогретый, мне не холодно вообще, потому что организм достаточно
                разогрелся и вот в такие моменты мне действительно тепло. Однако, вы понимаете, что для неподготовленного человека выйти разогретым на мороз - это сразу простуда.
                Для закалённого человека никаких последствий после этого не возникает. А ведь так иногда хочется выйти после интенсивной тренировки на свежий воздух и рука так и тянется
                расстегнуть куртку. <br>
                По причине того, что организм всё равно чувствует холод, то, как правило, пальцы рук зачастую мёзнут
                очень сильно, при сильном морозе даже немеют. В таких ситуациях я просто начинаю интенсивней работать пальцами, чтобы больше разогнать кровь. Но обычно такие ситуации случаются при
                морозе в -10 и ниже, особенно, если на улице ветер. Для того, чтобы немного уменьшить площадь открытой кожи на руках, я ношу спортивные перчатки без пальцев. Ну а иногда ношу их
                просто для понта :). 
            </p>
            <p>
                В заключение хочу сказать, что закаливание не делает из человека сверхчеловека, который может и в огонь, и в воду, и даже, я бы сказал, в медные трубы прыгнуть, нет. С помощью закаливания ты научаешь организм
                привыкать к холоду и получать от него удовольствие. Да, иногда тебе становится холодно так, что начинает трясти, пальцы рук при сильном морозе начинают неметь и ты начинаешь их
                греть, запихивая их в карманы штанов. Да, бывает некомфортно, но, как правило, эти неудобства можно перетерпеть. А если эти неудобства начинают появлятся систематически, то
                твой организм к этому начинает привыкать и ты становишься ещё сильнее!
            </p>
',
    'richtext' => 0,
    'template' => 3,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1486197742,
    'editedby' => 1,
    'editedon' => 1486440873,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1486203900,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'show_in_tree' => 0,
    'properties' => '{"hitspage":{"hitts":47}}',
    'image' => 
    array (
      0 => 'image',
      1 => 'assets/templates/images/hardening/Me.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'tags',
      1 => 'закаливание, стереотипыозакаливании',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html>
  ...
  <head>
    <title>Закаливание вредит вашему здоровью!</title>
  ...
  <ul class="mobile-sub wsmenu-list">
    <li><li class="first"><a href="index.php?id=1" >Главная</a></li><li class="active"><a href="index.php?id=2" >Закаливание</a></li><li><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></li>
  </ul>
</nav>
          </div>
          <!--Menu HTML Code-->
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="share-fixed">
            <ul class="widget-social">
              <li>
                <h3>Поделиться:</h3></li>
                <li><a target="_blank" class="popup-share" href="https://vk.com/share.php?url=http://buildyourself.by/index.php?id=63"><span class="icon-vk"></span></a></li>
<li><a target="_blank" class="popup-share" href="http://www.facebook.com/sharer/sharer.php?u=http://buildyourself.by/index.php?id=63"><span class="icon-facebook"></span></a></li>
<li><a target="_blank" class="popup-share" href="http://www.twitter.com/share?url=http://buildyourself.by/index.php?id=63&text=Закаливание вредит вашему здоровью!"><span class="icon-twitter"></span></a></li>
            </ul>
          </div>
        </div>
      </section>
        <div class="blog-post-fullwidth-featured js-parallax" data-parallax="scroll" data-image-src="assets/templates/images/hardening/Me.jpg">
        <div class="container-fluid">
          <div class="post-single-title"> 
          [[!tagLister? &parents=`63` &tv=`tags` &tpl=`single-tag` &target=`38`]]
            <h1>Закаливание вредит вашему здоровью!</h1>
            <div class="blog-single-meta" style="color: #333;">
              <p><a href="#" class="single-comments" id="comments"><span class="icon-comments-2"></span></a><a href="#" class="single-shares"><span class="icon-eye"></span>[[!HitsPage? &saveTv=`true`]]</a> </p>
            </div>
          </div>
      ...
      <section class="section clearfix">
        <div class="container-fluid">
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <div id="post-content" class="modern-layout">
            <p>
                Как я уже писал в <a href="index.php?id=61">одной из статей</a>, многие люди, зачастую пользуются стереотипами в тех ситуациях, когда
                не могут объяснить то, что видят. В случае с закаливанием, многие не понимают, как можно ходить в -10 в одной майке, именно поэтому
                мне не раз говорили: "Вот увидишь, попадёшь в больницу, носи тебе потом фрукты да овощи!" Однако, увидев меня в майке первый, второй, 
                третий раз, люди начинают недоумевать, как такое возможно и, понятное дело, их стереотип не может объяснить этого. И люди начинают тогда
                гуглить, читают разные статьи, однако, как я понял, читают их выборочно, или просто пропускают то, что написано (в скобках).
    ...
    <input type="hidden" name="pagetitle" value="Закаливание вредит вашему здоровью!" />
                          ...
                          success: function(data, textStatus){
                            ...
                            $.each(data, function(index, value){
                                var media = $("<div class=\'media\' id=\'" + value.id + "\'></div>")
                                  ...
                                  formHTML.append($("<input type=\'hidden\' name=\'page_id\' value=\'" + 63 + "\'>"));
                                  formHTML.append($("<input type=\'hidden\' name=\'pagetitle\' value=\'Закаливание вредит вашему здоровью!\'>"));
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sidebar right">
            <div class="widget">
              ...
              <ul class="sidebar-category">
                <ul class=""><li class="first"><a href="index.php?id=1" >Главная</a></li><li class="active"><a href="index.php?id=2" >Закаливание</a></li><li><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></ul>
              </ul>
            </div>
            <div class="widget">
...
<script type="text/javascript" src="assets/templates/js/social-widgets-config.js"></script>
  ...
  'elementCache' => 
  array (
    '[[$includes-single]]' => '<title>Закаливание вредит вашему здоровью!</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="initial-scale=1.0,user-scalable=no,maximum-scale=1">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="HandheldFriendly" content="True">
  ...
  <!-- <form class="search-form-popup" role="search" action="" method="[[+method:default=`get`]]">
    ...
    '[[pdoMenu?
        &parents=`0`
        &level=`1`
        &tplOuter=`@INLINE <li>[[+wrapper]]</li>`]]' => '<li><li class="first"><a href="index.php?id=1" >Главная</a></li><li class="active"><a href="index.php?id=2" >Закаливание</a></li><li><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></li>',
