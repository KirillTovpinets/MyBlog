<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги.',
    'longtitle' => '',
    'description' => '',
    'alias' => 'ishhite-sebya',
    'link_attributes' => '',
    ...
    'parent' => 3,
    'isfolder' => 0,
    'introtext' => 'Скажи мне, сколько у тебя друзей ВКонтакте, и я скажу тебе, сколько у тебя контактов.',
    'content' => '<div class="blog-post-fullwidth-featured js-parallax" data-parallax="scroll" data-image-src="assets/templates/images/programming/IMG_0013.JPG">
        <div class="container-fluid">
          <div class="post-single-title"> 
          [[!tagLister? &parents=`[[*id]]` &tv=`tags` &tpl=`single-tag` &target=`38`]]
            <h1>[[*pagetitle]]</h1>
            <div class="blog-single-meta">
              <p> <a href="#" class="single-comments"><span class="icon-comments-2"></span><!-- 24 --></a><a href="#" class="single-shares"><span class="icon-eye"></span>[[!HitsPage? &saveTv=`true`]]</a> </p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div id="post-content" class="modern-layout">
                <p>
                    <small style="padding:10px;">
                        На фоторафии совместное селфи моих лучших друзей, с которыми я жил в общаге. Это первое селфи, которое они сделали, когда я купил себе iphone.
                        Про одного из этих парней Вы уже читали на главной странице в предисловии к категории "Бег" - это Вася (слева). Но этот пост я бы хотел посвятить своему
                        второму сокамернику - Яну.
                    </small>
                </p>
                <p>
                    Сколько у вас друзей ВКонтакте? 100? 200? 300? Кто у вас находится первым в списке друзей? Отлично, а кто у вас 57-й? Вот тут уже проблема, не так ли? <br>
                    Мы живём во время информационных технологий, когда взаимодействие между людьми стало куда более доступным, чем это было 15 лет назад. Социальные сети глубоко зашли в нашу жизнь
                    и мы, порой, и дня не проводим, чтобы не зайти ни в контакт, ни в facebook, ни в instagram.
                    Я ничего не имею против социальных сетей. Социальные сети - это отличный инструмент для поддержания контактов с людьми, отличное средство поделиться
                    с друзьями фотографиями, видеофайлами, мыслями и т. д. Также это отличный инструмент для того, чтобы найти своих старых знакомых, одноклассников. Однако
                    в современном мире наблюдается тенденция, когда социальные сети полностью заменяют живое общение. Создаются различные сайты знакомств, онлайн чаты с "незнакомцем"
                    и так далее. Но можно ли заменить реального друга на "друзей" в контакте? Если честно, я бы заменил название этой колонки ВКонтакте на "Контакты", а не "Друзья".
                    К тому же это более созвучно с названием социальной сети, чем "Друзья". <br>
                    Известная всему миру фраза "Друг познаётся в беде" ясно говорит нам о том, что в виртуальном мире найти друзей невозможно. Беда - вот, что определяет друзей. А какие
                    беды с вами могут случиться в социальной сети? Страничку взломали? Проиграли все фишки в Poker Jet и так хотите, чтобы "друг" поделился с Вами фишками? Смешно, не правда ли?
                    Да, согласен, бывает возможность помочь человеку починить компьютер с помощью программы teamviewer, однако даже для того, чтобы дать доступ к своему компьютеру другому
                    человеку, нужно довольно хорошо доверять ему. Но можно ли это доверие завоевать в сети Интернет? Я думаю, вряд ли. Именно поэтому заменить реального друга никакие
                    социальные сети не смогут! <br>
                    Взаимное доверие достигается очень долго и порой даже приходится жертвовать собственным "Я" ради того, чтобы завоевать доверие друга. Процесс построения доверия
                    друг к другу - это как процесс строения здания. Кирпичик за кирпичиком, ситуация за ситуацией, и спустя долгое время вы получаете дружбу, которую невозможно разбить. Знаете,
                    скажу честно. Во время моей учёбы в Академии управления я видел, что многие мои однокурсники разделялись по группам и общались только в ограниченном
                    круге. Я наблюдал за этими группами, особенно, как староста, мне было интересно наблюдать за тем, как эти группы формируются, как из одной группы человек переходит в другую и пытается
                    стать в этой группе "своим". Я понимал, что разделение группы на подгруппки - это неизбежность, так как группа из 30 человек - это большой коллектив, где каждый старается немного
                    сузить круг общения и найти себе друзей по своему вкусу, по интересам. Однако, как это ни печально, но я не нашёл среди своих однокурсников группу людей, с которыми мне было бы комфортно.
                    Я не скажу, что я был изгоем на курсе, вовсе нет. Я общался со всеми, со всеми имел хорошие отношения, даже приносил и раздавал всем своим однокурсникам конфеты без повода, просто так, без причины.
                    Все ещё тогда спрашивали: "Кирилл, у тебя ж вроде днюха в феврале, а сейчас июль вроде! По какому поводу такая щедрость?" А мне не нужна была причина для того, чтобы всем своим однокурсникам
                    подарить немного позитива и сладости. Я люблю быть непредсказуемым :)<br>
                    Помогал я с программированием всем и каждому и, сколько себя помню, никому не отказывал в помощи. Отказывал в случаях, когда уже явно видел, что меня запросто используют. И я думал, что
                    своей помощью другим я завоюю пару-тройку друзей, которые мне в будущем тоже подадут руку помощи, когда я в ней буду нуждаться. Но во время того, как я искал место распределения из всех моих однокурсников
                    лишь пару человек интересовались тем, нашёл ли я работу или нет. Даже в своём тяжёлом положении с распределением я находил в себе силы утешать свою однокурсницу, которая всё плакалась мне, что
                    работы нет, у неё нет места распределения, она пойдёт работать в макдональдс и так далее. Я вселял надежду в неё, говорил ей, что она будет успешной и обязательно найдёт место распределения и не будет работать в
                    макдаке! Так и случилось, она нашла отличную высокооплачиваемую работу в IT-компании. И всё на этом. Спасибо, Кирилл, дальше я сама. Но помощи и предложений типа "Давай я поговорю со своим начальством, может тебя возьмут к нам" не было.
                    И вплоть до самого дня 
                    распределения помощь предложили лишь Вася, и Даша Романовская, но, к сожалению, у меня не хватало знаний в тех сферах, где они работают. Однако всю историю моего распределения и поисков работы
                    знал только один человек - Ян Бедушевский. Он единственный, кто помог мне устроится и уговорил начальство взять меня
                    на работу. Вакансии не было, но начальство специально ради меня открыло новую должность и меня взяли на работу. Где были те 190 "друзей" ВКонтакте, 90 из которых - мои однокурсники, которым я
                    помогал делать лабы и курсачи по программированию? Лишь один из всех этих 200 друзей в вк оказался настоящим другом, который знал о моей проблеме, знал, куда меня распределили, и не забыл меня, когда
                    у него было всё налажено и он был уже с работой. Вот, что значит, настоящая дружба, проверенная временем, когда в благоприятные дни ты не забываешь о своём друге, который нуждается в твоей помощи. <br>
                    Ян - это тот человек, с которым нас объединяет 2 года жизни в общаге. С ним мне не нужны были эти "группки" среди однокурсников. И благодаря ему, возвращаясь с пар в общагу, я всегда знал, что меня ждёт
                    что-то очень весёлое в комнате. Да, были ситуации, когда Ян злился на меня, я злился на него, но всё это проходило быстро, потому что это настоящая дружба, когда злиться друг на друга долго не получается, и в памяти
                    то и дело всплывает этот возглас в 3 часа ночи: "АСАСИНС КРИД!!!!!!!". И даже после того, как нас расселили по разным комнатам, мы не забывали друг друга. Когда мне нужно было настроить маршрутизатор в новой комнате,
                    Ян был первым, кто приходил его настраивать. С этим человеком также связана и моя первая книга по программированию. Именно он завёл меня в книжный магазин и познакомил меня с книгой, которая изменила мою жизнь и привила мне
                    любовь к программированию и разработке.
                </p>
                <p>
                    Мы все не идеальны, у каждого из нас есть недостатки, есть свои тараканы в голове. И настоящая дружба невозможна без принятия этих тараканов в голове другого. Когда ты
                    знаешь недостатки друга, но ради его достоинств, ты смиряешься с его недостатками, когда ты знаешь, как человек себя ведёт в разных жизненных ситуациях, когда ты вместе с ним
                    отгребал от заведующей общаги за сломаные двери, когда ты не забываешь своего друга во время, когда у тебя всё хорошо и ты не терпишь недостаток ни в чём - вот это настоящая дружба!
                    Вот это я называю реальной жизнью! А все эти 200/300/400 "друзей" ВКонтакте - это всего лишь "контакты", с которыми ты в контакте, не более!
                </p>',
    'richtext' => 0,
    'template' => 3,
    'menuindex' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1486323060,
    'editedby' => 1,
    'editedon' => 1486440966,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1486396020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'image',
      1 => 'assets/templates/images/programming/IMG_0013.JPG',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'tags',
      1 => 'Программирование, ДругВБедеНеБросит',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html>
  ...
  <head>
    <title>Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги.</title>
  ...
  <ul class="mobile-sub wsmenu-list">
    <li><li class="first"><a href="index.php?id=1" >Главная</a></li><li><a href="index.php?id=2" >Закаливание</a></li><li class="active"><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></li>
  </ul>
</nav>
          </div>
          <!--Menu HTML Code-->
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="share-fixed">
            <ul class="widget-social">
              <li>
                <h3>Поделиться:</h3></li>
                <li><a target="_blank" class="popup-share" href="https://vk.com/share.php?url=http://buildyourself.by/index.php?id=66"><span class="icon-vk"></span></a></li>
...
<li><a target="_blank" class="popup-share" href="http://www.twitter.com/share?url=http://buildyourself.by/index.php?id=66&text=Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги."><span class="icon-twitter"></span></a></li>
        ...
        <div class="blog-post-fullwidth-featured js-parallax" data-parallax="scroll" data-image-src="assets/templates/images/programming/IMG_0013.JPG">
        <div class="container-fluid">
          <div class="post-single-title"> 
          [[!tagLister? &parents=`66` &tv=`tags` &tpl=`single-tag` &target=`38`]]
            <h1>Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги.</h1>
            <div class="blog-single-meta">
              <p> <a href="#" class="single-comments"><span class="icon-comments-2"></span><!-- 24 --></a><a href="#" class="single-shares"><span class="icon-eye"></span>[[!HitsPage? &saveTv=`true`]]</a> </p>
            </div>
          </div>
    ...
    <input type="hidden" name="pagetitle" value="Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги." />
                          ...
                          success: function(data, textStatus){
                            ...
                            $.each(data, function(index, value){
                                var media = $("<div class=\'media\' id=\'" + value.id + "\'></div>")
                                  ...
                                  formHTML.append($("<input type=\'hidden\' name=\'page_id\' value=\'" + 66 + "\'>"));
                                  formHTML.append($("<input type=\'hidden\' name=\'pagetitle\' value=\'Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги.\'>"));
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sidebar right">
            <div class="widget">
              ...
              <ul class="sidebar-category">
                <ul class=""><li class="first"><a href="index.php?id=1" >Главная</a></li><li><a href="index.php?id=2" >Закаливание</a></li><li class="active"><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></ul>
              </ul>
            </div>
            <div class="widget">
...
<script type="text/javascript" src="assets/templates/js/social-widgets-config.js"></script>
  ...
  'elementCache' => 
  array (
    '[[$includes-single]]' => '<title>Друг всегда заплатит за проезд в метро за двоих, предварительно взяв у тебя деньги.</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="initial-scale=1.0,user-scalable=no,maximum-scale=1">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="HandheldFriendly" content="True">
  ...
  <!-- <form class="search-form-popup" role="search" action="" method="[[+method:default=`get`]]">
    ...
    '[[pdoMenu?
        &parents=`0`
        &level=`1`
        &tplOuter=`@INLINE <li>[[+wrapper]]</li>`]]' => '<li><li class="first"><a href="index.php?id=1" >Главная</a></li><li><a href="index.php?id=2" >Закаливание</a></li><li class="active"><a href="index.php?id=3" >Программирование</a></li><li><a href="index.php?id=5" >Паркур</a></li><li class="last"><a href="index.php?id=8" >Бег</a></li></li>',
